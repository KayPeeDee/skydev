...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Register My Business') }}</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('register_my_business') }}">
                            @csrf
                            <input  type="hidden"  name="business_owner" value="{{ Auth::id() }}">
